export function SocialIcons() {
  const socialPlatforms = [
    ...
    },
    {
      ...
      bgColor: "#c13584",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512" className="[&>svg]:h-4 [&>svg]:w-4">
    ...
    {
      href: "https://www.youtube.com/@UCBNoteworthy",
      bgColor: "#ff0000",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512" className="[&>svg]:h-4 [&>svg]:w-4">
    ...
    <div className="flex flex-row gap-2 place-content-center">
      {socialPlatforms.map((platform, index) => (
        <a key={index} href={platform.href}>
          ...
          >
            <span className="[&>svg]:h-4 [&>svg]:w-4">{platform.icon}</span>
          </button>
        </a>
      ))}
    </div>
